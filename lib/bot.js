...
const SkipCommand   = require('./commands/skip-command');
...
class Bot {
  ...
  _initializeCommands () {
    ...
    this.commands = [
      ...
      new SkipCommand(defaultCommandArgs),
      new StopCommand(defaultCommandArgs),
      new ResetCommand(defaultCommandArgs),
      new StatsCommand(defaultCommandArgs),
